...
const CSV = () => {
            ...
            Papa.parse(e.target.result, {
                ...
                complete: (results) => {
                    ...
                    const processedData = results.data.map((row) => {
                        const newRow = { ...row };
                        if (newRow.Timestamp) {
                            const { date, time } = parseDate(newRow.Timestamp);
                            newRow.date = date;
                            newRow.time = time;
    ...
    return (
        <div className="max-w-6xl mx-auto mt-4 sm:mt-10 p-4 sm:p-6 bg-blue-300 rounded-lg shadow-xl">
...
const Table = React.memo(
    ({ data, columns, currentPage, rowsPerPage, paginate }) => {
